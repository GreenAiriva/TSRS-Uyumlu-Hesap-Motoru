/* ============================================================
   UYGULAMA AYARLARI VE METİNLERİ
   ------------------------------------------------------------
   Uygulamanın başlığı, sürüm bilgisi, kılavuz metinleri ve genel
   ayarlar burada tutulur.
   NASIL DÜZENLENİR?
   • En kolay yol: Yönetim Paneli → "Görünüm ve Metinler" sekmesi.
   • Elle düzenleme: "tırnak içindeki" metinleri değiştirin.
   ============================================================ */
...
VERI.ayarlar = {
 ...
 "kilavuz_adimlar": [
  ...
  "TSRS'nin dört temel içeriğini tamamlayın: Yönetişim, Strateji, Risk Yönetimi, Metrikler ve Hedefler.",
  "Önemlilik Değerlendirmesi, Karşılaştırmalı Bilgi ve Muhakemeler bölümlerini gözden geçirin.",
  "Gösterge Paneli'nden sonuçları kontrol edin ve Karbon Envanteri Raporu'nu yazdırın (A4)."
 ],
 "rapor_dipnotu": "Bu rapor, TSRS 1 ve TSRS 2 standartlarına uyum amacıyla Karbon Ayak İzi Hesap Motoru ile oluşturulmuştur."
};
